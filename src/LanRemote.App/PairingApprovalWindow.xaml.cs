...
public partial class PairingApprovalWindow : Window
{
    ...
    public PairingApproval Approval { get; private set; } = new(false, false);

    private void AcceptButton_Click(object sender, RoutedEventArgs e)
    {
        Approval = new PairingApproval(true, AllowFileTransferCheckBox.IsChecked == true);
        DialogResult = true;
    }

    private void RejectButton_Click(object sender, RoutedEventArgs e)
    {
        Approval = new PairingApproval(false, false);
        DialogResult = false;
    }
}
